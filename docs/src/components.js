		...
		cards: [
				...
				boxes: [
					{
						...
						body: `
            <link rel="stylesheet" href="https://unpkg.com/@ignatiusmb/aqua@${version}/lib/core.css">
            `,
					},
				],
			},
			{
				...
				boxes: [
					{
						language: 'html',
						title: 'Direct <script> Include --> CDN',
						body: `
				...
				boxes: [
					{
						...
						title: 'Direct <script> Include --> CDN',
						body: `
            <link rel="stylesheet" href="https://unpkg.com/@ignatiusmb/aqua@${version}/lib/code.css">
            <script defer src="https://unpkg.com/@ignatiusmb/aqua@${version}/lib/code.js"></script>
            `,
					},
					{
						language: 'html',
				...
				boxes: [
					{
						...
						title: 'Direct <script> Include --> CDN',
						body: `
            <link rel="stylesheet" href="https://unpkg.com/@ignatiusmb/aqua@${version}/lib/form.css">
            <script defer src="https://unpkg.com/@ignatiusmb/aqua@${version}/lib/form.js"></script>
            `,
					},
					{
						language: 'html',
				...
				boxes: [
					{
						...
						title: 'Direct <script> Include --> CDN',
						body: `
            <link rel="stylesheet" href="https://unpkg.com/@ignatiusmb/aqua@${version}/lib/modal.css">
            <script defer src="https://unpkg.com/@ignatiusmb/aqua@${version}/lib/modal.js"></script>
            `,
					},
					{
						language: 'html',
